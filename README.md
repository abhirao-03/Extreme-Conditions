# Extreme-Conditions
Some initial visualisations from 2D extension of simple compressible euler equations can be seen below. These visualisations were created using `visualise.py`, a script located in the `visualisation` folder. This script was written in whole by Gemini-3-Pro as a placeholder. In the future, I plan to use VisIt/ParaView to visualise large-scale simulations. All other code was written by me with minimal, if any, use of AI. The 1-dimensional base of this code can be found in my other repo [Compressible-Fluids](https://github.com/abhirao-03/Compressible-Fluids).
